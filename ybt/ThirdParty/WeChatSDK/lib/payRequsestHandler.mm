...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSDictionary *)param
{
//    NSLog(@"param:%@",param);
    //订单标题，展示给用户
    NSString *order_name    = [param objectForKey:@"order_name"];
    //订单金额,单位（分）
    NSString *order_price   = [NSString stringWithFormat:@"%.f",[[param objectForKey:@"order_price"] floatValue] * 100];//1分钱测试
    NSString *order_no      = [NSString stringWithFormat:@"%@",[param objectForKey:@"order_no"]];
